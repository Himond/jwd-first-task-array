...
public class TestArraySort {
    ...
    public void exchangesSortTest() {
        ...
        ArrayMod actual = ArraySort.exchangesArraySort(basicArray);
        Assert.assertArrayEquals(expected, actual.getArray(), 0.001);
    ...
    public void insertSortTest() {
        ...
        ArrayMod actual = ArraySort.insertArraySort(basicArray);
        Assert.assertArrayEquals(expected, actual.getArray(), 0.001);
    ...
    public void shellSortTest() {
        ...
        ArrayMod actual = ArraySort.shellArraySort(basicArray);
        Assert.assertArrayEquals(expected, actual.getArray(), 0.001);
